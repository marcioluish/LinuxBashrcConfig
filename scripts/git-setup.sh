...
# --- Git autocompletion ---
# Loads the git completion framework (defines __git_complete).
# The actual git aliases and their __git_complete calls live in aliases.sh,
...
# NOTE: This function is defined here but should be CALLED after all aliases are defined
#       (e.g., at the end of .bashrc) to ensure all aliases get completions wired up.
